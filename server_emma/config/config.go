...
import (
	...
	"GolandProjects/apaxos-gautamsardana/server_emma/storage/logstore"
	pool "GolandProjects/apaxos-gautamsardana/server_pool"
)

const configPath = "/go/src/GolandProjects/apaxos-gautamsardana/server_emma/config/config.json"
